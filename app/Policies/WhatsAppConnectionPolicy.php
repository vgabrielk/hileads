...
class WhatsAppConnectionPolicy
{
    ...
    {
        return $user->id === $whatsAppConnection->user_id;
    }
     ...
     */
    public function restore(User $user, WhatsAppConnection $whatsAppConnection): bool
    {
        return false;
    }
     ...
     */
    public function forceDelete(User $user, WhatsAppConnection $whatsAppConnection): bool
    {
        return false;
    }
}
