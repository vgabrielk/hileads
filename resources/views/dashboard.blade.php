    ...
    @if($accessStatus['is_admin'])
        <div class="relative rounded-lg border border-primary/20 bg-primary/10 p-4 flex items-start gap-3">
            ...
            <div class="flex-1">
                ...
                <p class="text-sm text-primary opacity-90">Você tem acesso completo a todas as funcionalidades do sistema.</p>
            </div>
        </div>
    ...
    @else
        <div class="relative rounded-lg border border-warning/20 bg-warning/10 p-4 flex items-start gap-3">
            ...
            <div class="flex-1">
                ...
                <p class="text-sm text-warning opacity-90">Você precisa de uma assinatura ativa para acessar todas as funcionalidades.</p>
            </div>
                ...
                @forelse($recentConnections as $connection)
                    <div class="flex items-center gap-3 p-3 rounded-lg hover:bg-accent/50 transition-colors">
                        ...
                        <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium
                            ...
                            {{ $connection->status === 'connected' ? 'Conectado' : ($connection->status === 'disconnected' ? 'Desconectado' : 'Pendente') }}
                        </span>
                    </div>
                @empty
