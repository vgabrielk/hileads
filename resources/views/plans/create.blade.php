            ...
            <div class="p-6 space-y-6">
                ...
                <div>
                    ...
                    <textarea id="description" 
                              ...
                              placeholder="Ex: Ideal para começar com o sistema">{{ old('description') }}</textarea>
                    @error('description')
                        <p class="mt-2 text-sm text-destructive">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div>
                        ...
                        <select id="interval" 
                                ...
                                class="w-full px-4 py-3 border border-input rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-primary focus:border-primary transition-colors bg-background text-foreground"
                                required>
                            <option value="monthly" {{ old('interval') === 'monthly' ? 'selected' : '' }}>Mensal</option>
...
// Initialize with existing features if any
@if(old('features'))
