...
<div class="p-4 sm:p-6 lg:p-8 space-y-4 sm:space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
            ...
            <p class="text-muted-foreground mt-1">Visualize e gerencie esta notificação</p>
        </div>
        ...
        <div class="lg:col-span-2 space-y-4 sm:space-y-6">
            ...
            <div class="bg-card rounded-lg border border-border p-4 sm:p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        <label class="block text-sm font-medium text-muted-foreground mb-1">Status do Usuário</label>
                        <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium
        ...
        <div class="space-y-4 sm:space-y-6">
            ...
            <div class="bg-card rounded-lg border border-border p-4 sm:p-6">
                ...
                <div class="space-y-2">
                    ...
                    <form method="POST" action="{{ route('admin.notifications.destroy', $notification) }}" class="inline-block w-full">
                        ...
                        @method('DELETE')
                        <button type="submit" 
                                onclick="return confirm('Tem certeza que deseja excluir esta notificação? Esta ação não pode ser desfeita.')"
                                class="w-full inline-flex items-center justify-center gap-2 px-4 py-2 text-sm font-medium text-destructive-foreground bg-destructive hover:bg-destructive/90 rounded-lg transition-colors">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="bg-card rounded-lg border border-border p-4 sm:p-6">
                ...
                <div class="space-y-2 text-sm text-muted-foreground">
                    ...
                    <p><strong>Excluir:</strong> Remove a notificação permanentemente.</p>
                </div>
            </div>
        </div>
    </div>
