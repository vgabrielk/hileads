    ...
    <div class="max-w-2xl mx-auto">
        ...
        <div class="mb-8">
            <a href="{{ route('admin.users.index') }}" class="inline-flex items-center text-sm font-medium text-gray-600 hover:text-gray-900 mb-4 transition-colors">
                ...
                Voltar para usuárioes
            </a>
            <h1 class="text-3xl font-bold text-gray-900">Editar Usuário</h1>
            <p class="mt-2 text-sm text-gray-600">Modifique os dados do usuário</p>
        </div>
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                ...
                <div class="p-6 space-y-6">
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-xs text-gray-500">Usuárioes inativos não podem fazer login no sistema</p>
                    </div>
                </div>
            </div>
