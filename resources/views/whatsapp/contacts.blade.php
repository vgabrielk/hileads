    ...
    <div>
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-muted-foreground mt-1">Gerencie seus contatos do WhatsApp</p>
            </div>
            <div class="space-x-2">
            ...
            <div class="grid md:grid-cols-2 gap-6">
                <div class="bg-white rounded shadow p-4">
                    ...
                    <form method="POST" action="{{ route('whatsapp.user-info') }}" class="space-y-2">
                        ...
                        <button class="px-3 py-2 bg-blue-600 text-white rounded">Buscar Info</button>
                    </form>
            ...
            <div class="grid md:grid-cols-2 gap-6 mt-6">
                ...
                <div class="bg-white rounded shadow p-4">
                    ...
                    <form method="POST" action="{{ route('whatsapp.delete') }}" class="space-y-2 mt-2">
                        ...
                        <button class="px-3 py-2 bg-red-600 text-white rounded">Deletar</button>
                    </form>
