...
<div class="p-4 sm:p-6 lg:p-8 space-y-4 sm:space-y-6">
    ...
    <div>
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <a href="{{ route('whatsapp.connect') }}" class="inline-flex items-center gap-2 px-4 py-2 text-sm font-medium text-primary-foreground bg-primary hover:bg-primary/90 rounded-lg transition-colors w-full sm:w-auto justify-center">
        ...
        @isset($status)
            <div class="mb-6">
                @if(!$status['success'])
                    <div class="bg-warning/10 border-l-4 border-warning rounded-lg p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-3">
                                <p class="text-sm font-medium text-warning-foreground">{{ $status['message'] ?? 'Não foi possível obter o status da conexão.' }}</p>
                            </div>
                        </div>
                    </div>
                @else
