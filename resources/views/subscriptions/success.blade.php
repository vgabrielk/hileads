...
<div class="py-8 px-4 sm:px-6 lg:px-8 animate-fadeIn">
    <div class="max-w-4xl mx-auto">
        ...
        <div class="mb-8 text-center">
            ...
            <p class="text-lg text-gray-600">Seu pagamento foi processado com sucesso</p>
        </div>
            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center">
                    ...
                    <div>
                        ...
                        @else
                            <p class="text-green-700">Sua assinatura está ativa e pronta para uso!</p>
                        @endif
                    </div>
                </div>
            </div>
            ...
            <div class="card-hover bg-white rounded-2xl shadow-sm border border-gray-100 p-6 hover:shadow-xl transition-all">
                <div class="flex items-start">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-600">Atendimento rápido e dedicado para você</p>
                    </div>
                </div>
            </div>
            ...
            <div class="card-hover bg-white rounded-2xl shadow-sm border border-gray-100 p-6 hover:shadow-xl transition-all">
                <div class="flex items-start">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-600">Acesse todas as funcionalidades avançadas</p>
                    </div>
                </div>
            </div>
